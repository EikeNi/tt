...
def action_day():
    ...
    for day in sorted(report.keys()):
        print(
            day,
            sep,
            reportingutils.remove_seconds(report[day]["start"].time()),
            sep,
            reportingutils.remove_seconds(report[day]["end"].time()),
            sep,
            reportingutils.remove_seconds(
                (report[day]["end"] - report[day]["start"])
                - report[day]["work_duration"]
            ),
            sep,
            reportingutils.remove_seconds(report[day]["work_duration"]),
        )
